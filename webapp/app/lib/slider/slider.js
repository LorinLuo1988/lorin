...
(function ($) {
	...
	Slider.prototype.destroy = function () {
		this.slider.off("mouseenter");
		this.slider.off("mouseleave");
	...
	Slider.prototype.mouseenterFun = function (event) {
	...
	Slider.prototype.mouseleaveFun = function (event) {
		var self = event.data.context;
	...
	Slider.prototype.nextClickFun = function (event) {
		var self = event.data.context;
	...
	Slider.prototype.prevClickFun = function (event) {
		var self = event.data.context;
	...
	Slider.prototype.registerEvent = function () {
		...
		this.slider.on("mouseenter", {context: this}, this.mouseenterFun);

		this.slider.on("mouseleave", {context: this}, this.mouseleaveFun);

		this.nextButton.on("click", {context: this}, this.nextClickFun);

		this.prevButton.on("click", {context: this}, this.prevClickFun);
